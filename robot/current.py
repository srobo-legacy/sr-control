...
_MAX_INPUT_CURRENT = 15

class Current(IOWidgetBase):
    ...
    def _draw(self, cr, w, h):
        if self.value > 0:
            ...
            top = (1 - self.value / _MAX_INPUT_CURRENT) * inner_height
